...
const hasChildrenValues = (arr, character) => {
  // let children;
  // arr.forEach(person => {
  //   if (Object.values(person)[0] === character && Object.values(person)[2].length !== 0) children = true;
  //   else if (Object.values(person)[0] === character && Object.values(person)[2].length === 0) children = false;
  // })
  // return children;
...
const hasChildrenEntries = (arr, character) => {
  // let children;
  // arr.forEach(person => {
  //   if (Object.entries(person)[0][1] === character && Object.entries(person)[2][1].length !== 0) children = true;
  //   else if (Object.entries(person)[0][1] === character && Object.entries(person)[2][1].length === 0) children = false;
  // })
  // return children;
...
const totalCharacters = (arr) => {
  ...
  arr.forEach(character => {
    characterCount++;
    if (character.spouse !== null) characterCount++;
    if (character.children.length) characterCount += character.children.length;
  })
...
const houseSize = (arr) => {
  ...
  arr.forEach(house => {
    let members = 1;
    if (house.spouse !== null) members += 1;
    if (house.children.length) members += house.children.length;
    sizes.push({
      'house': house.house,
      'members': members
    })
...
const houseSurvivors = (arr) => {
  const survivors = [];
  arr.forEach(character => {
    let members = character.children.length + 1;
    if (character.spouse && !deceasedSpouses.includes(character.spouse)) members += 1;
    survivors.push({
      'house': character.house,
      'members': members
    })
